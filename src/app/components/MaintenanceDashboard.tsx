...
export function MaintenanceDashboard() {
  ...
  return (
    <div className="min-h-full p-8 bg-slate-950 font-sans text-slate-300 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 border-b border-slate-800 pb-6">
        ...
        <div className="flex bg-slate-900 border border-slate-800 p-1.5 rounded-2xl shadow-inner overflow-x-auto w-full md:w-auto flex-nowrap">
          <button
