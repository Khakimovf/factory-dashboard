...
export function EmployeeCabinet() {
  const { t } = useLanguage();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  <DetailRow icon={Briefcase} label={t('employeeCabinet.profile.position')} value={mockCurrentEmployee.position} />
                  <DetailRow icon={Building} label={t('employeeCabinet.profile.department')} value={mockCurrentEmployee.department} />
                  <DetailRow
                    icon={Calendar}
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t('employeeCabinet.attendance.checkIn')}</p>
                    <p className="text-lg font-semibold text-gray-900 dark:text-white">{todayRecord.checkIn || '-'}</p>
                  </div>
                  <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t('employeeCabinet.attendance.checkOut')}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t('employeeCabinet.leave.totalExperience')}</p>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {workExp.years} {t('employeeCabinet.leave.years')} {workExp.months} {t('employeeCabinet.leave.months')}
                </p>
              </div>
              <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/20">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t('employeeCabinet.leave.companyExperience')}</p>
                <p className="text-lg font-semibold text-gray-900 dark:text-white">
                  {workExp.years} {t('employeeCabinet.leave.years')} {workExp.months} {t('employeeCabinet.leave.months')}
                </p>
              </div>
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">{t('employeeCabinet.leave.annualLeave')}</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">{t('employeeCabinet.leave.used')}</span>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-gray-600 dark:text-gray-400">{t('employeeCabinet.leave.remaining')}</span>
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {mockDocuments.map((doc) => (
              ...
              >
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">{getDocumentTypeLabel(doc.type)}</p>
